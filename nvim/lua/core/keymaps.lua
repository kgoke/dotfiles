...
vim.keymap.set('n', '<leader>h', '<C-w>h', opts) -- split weindow horizontally
vim.keymap.set('n', '<leader>se', '<C-w>=', opts) -- make splits equal size
vim.keymap.set('n', '<leader>xs', ':close<CR>', opts) -- close splits

-- Navigate between splits (move with regular vim keys)
...
vim.keymap.set('n', '<leader>tp', ':tabp<CR>', opts) -- go to prev tab
